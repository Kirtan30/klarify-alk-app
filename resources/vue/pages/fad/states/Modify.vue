...
export default {
    ...
    methods: {
        ...
        async handleSaveState() {
            ...
            try {
                ...
                let { data } = this.form.id ?
                    await axios.put(`/app/fad/states/${this.form.id}`, parameters) :
                    await axios.post('/app/fad/states', parameters);

                this.manageTempForm();
                await this.$router.push({name: 'fad.states'});
        ...
        async getState(stateId) {
            try {
                let {data} = await axios.get(`/app/fad/states/${stateId}`);
                this.form = data.fadState || {};
